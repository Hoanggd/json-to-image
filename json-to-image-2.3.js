...
function normalExport(doc, variant, theOutputPath) {
  app.activeDocument = doc;
  var myDocument = app.activeDocument;
  var textLayers = gettextLayers(myDocument);
  var names = variant.customeNames;
...
function gettextLayers(documents) {
  var layers = documents.artLayers;
  var textLayers = [];
...
function findVariant(docName, data) {
...
function getData() {
  var jsonPath = File.openDialog("Chon file .json", "*.json", true);
  var jsonFile = File(jsonPath[0]);
  jsonFile.open("r");
...
function chooseFormat() {
  ...
  win.pnl1.format1 = win.pnl1.add("radiobutton", undefined, "JPG");
  win.pnl1.format1.value = true;
  win.pnl1.format2 = win.pnl1.add("radiobutton", undefined, "PNG");
  win.pnl1.format3 = win.pnl1.add("radiobutton", undefined, "PDF");
